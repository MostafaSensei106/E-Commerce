...
func (q *Queries) GetOrderItem(ctx context.Context, arg GetOrderItemParams) (OrdersItem, error) {
...
func (q *Queries) GetOrderItemsByOrderID(ctx context.Context, orderID int64) ([]OrdersItem, error) {
